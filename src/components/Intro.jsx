...
const Intro = () => {
  return (
    <Box >
      <div className="mainBg h-screen w-full text-black overflow-hidden ">
        {/* <Alert severity="success">'heeey</Alert> */}
        <div className='mx-auto mt-32 w-10/12 xl:w-8/12 flex flex-row-reverse px-10'>
