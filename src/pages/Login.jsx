        ...
        <div className="w-full bg-white rounded-tr-lg rounded-br-lg  p-5">
          ...
          <div className='text-black my-8'>
            ...
            <div className='flex justify-center gap-3 mt-5 text-center'>
              <div className='p-3 border border-gray-300 rounded w-2/5 flex gap-5'><img src={fb}/>Facebook</div>

              <div className='p-3 border border-gray-300 rounded w-2/5 flex gap-5'><img src={gog}/>Google</div>
            </div>

          </div>

          <div className='mt-28'>
            <p className='text-black text-center'>Don&apos;t have an account? <Link to="/register" className='underline'>Register here</Link></p>
          </div>
        </div>
